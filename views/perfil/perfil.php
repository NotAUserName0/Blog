...
<div class="main_content">
    <h1 class="section_menu">Mis Post</h1>
        ...
        while ($post = mysqli_fetch_assoc($myPosts)) : ?>
            <div class="section_post">
                <div class="data_post">
                    ...
                    <a href="<?=base_url?>perfil/delete&entrada_id=<?=$post['id']?>" style="
                    position:absolute;
                    right:40px;        
                ...
                <div class="reactions_post">
                    ...
                    <?php if ($liked == true) : ?>
                        ...
                        <div class="post_box">
                            <a href="<?=base_url?>perfil/disliked&user=<?=$_SESSION['identity']->id?>&entrada=<?=$post['id']?>"><i class="fas fa-heart"></i> Like</a>
                        </div>

                    <?php else : ?>

                        <div class="post_box">
                            <a href="<?=base_url?>perfil/liked&user=<?=$_SESSION['identity']->id?>&entrada=<?=$post['id']?>"><i class="far fa-heart"></i> Like</a>
                        </div>
