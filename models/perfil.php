...
class Perfil{
    ...
    public function myPost($user)
    {
        ...
        $sql = "SELECT u.nombre,u.img,e.id, e.usuario_id, e.titulo, e.descripcion, e.fecha FROM usuarios u, entradas e WHERE u.id = e.usuario_id && e.usuario_id = $user ORDER BY e.fecha DESC;";
